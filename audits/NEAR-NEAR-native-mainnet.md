# Security Audit Report: NEAR Protocol (NEAR) - NEAR Mainnet
...
3. **Governance and holdings are less decentralized than branded.** The initial distribution sent about 36 percent to core team and backers versus roughly 12 percent to community, validator seats are concentrated, and the Foundation has pushed protocol upgrades forward against a validator vote.
...
| **Total supply (verified)** | ~1,302,305,440 NEAR (nearly fully unlocked) |
| **Inflation** | Gross cut from 5 percent to 2.5 percent (late 2025); max protocol inflation ~2.5 percent |
| **Burns** | Fees burned, historically minimal (~0.1 percent of supply) |
...
| Burns | Minimal historically (~0.1 percent), so net inflation ran near the full gross rate for years |
...
- The initial distribution sent roughly **36 percent to core team and backers** and only about **12 percent to community**.
- Validator participation is concentrated (a low-hundreds validator set, with governance historically limited to a few dozen effective validator voters), and the **Foundation has advanced protocol upgrades against a validator voting outcome**, publicly criticized by validators.
...
| NEAR-003 | **LOW** | Insider-heavy initial allocation (~36 percent team/backers vs ~12 percent community); validator/governance concentration; Foundation overrode a validator vote. |
