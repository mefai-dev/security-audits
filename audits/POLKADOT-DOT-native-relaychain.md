# Security Audit Report: Polkadot (DOT) on Polkadot Relay Chain
...
2. **Parachain adoption has thinned.** Of the parachains that have launched, MEFAI's review finds only a minority maintain consistent block production and volume, and ecosystem value locked has fallen to a low single digit share of DeFi, far below its 2021 peak. "Shared security" is real but demand for it has softened.
...
- **Adoption:** of the parachains that have launched, only a minority maintain consistent block production and volume; ecosystem value locked has fallen sharply to a low single digit share of DeFi, far below the ecosystem's early highs. Shared security is real but under demanded.
...
- **Decentralization design (positive):** equal per validator rewards regardless of stake, nominators selecting up to 16 validators, a nominator oversubscription cap and progressive slashing are genuine anti centralization mechanisms; the small active validator set is nonetheless a concentration ceiling relative to tens of thousands of nominators.
...
| DOT 002 | **MEDIUM** | Parachain adoption thinned: only a minority of launched parachains consistently active; ecosystem value locked down to a low single digit DeFi share. |
| DOT 003 | **LOW** | 2024 treasury spending surge (~87 million dollars/6 months) and runway concern; spending discipline contested. |
| DOT 004 | **LOW** | Active validator set (~600) is a concentration ceiling relative to the tens of thousands of nominators. |
...
| Validators / nominators | ~600 active / ~29,000 direct nominators |
